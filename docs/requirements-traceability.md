...
| CFI-05 | External gate | Production still requires an exact deployed origin/CORS pair, reviewed OpenAI account data controls, secret/configuration review, end-to-end issuer/origin/log/storage qualification, and integration-specific security approval.                                    |
