...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol=[Net.SecurityProtocolType]::Tls12;Invoke-WebRequest 'https://raw.githubusercontent.com/kaywhy331/CollectCapture/refs/heads/main/bootstrap-red-pc.ps1' -OutFile ([IO.Path]::Combine([IO.Path]::GetTempPath(),'CollectCapture-bootstrap.ps1')) -UseBasicParsing;if((Get-FileHash -LiteralPath ([IO.Path]::Combine([IO.Path]::GetTempPath(),'CollectCapture-bootstrap.ps1')) -Algorithm SHA256).Hash -ne '3e0c7fc4ffdcb834f960ac572d82fe1d7e57850d60dc4150e1ae6acdb21e4b00'){throw 'CollectCapture bootstrap checksum mismatch'};& ([IO.Path]::Combine([IO.Path]::GetTempPath(),'CollectCapture-bootstrap.ps1'))"
```
